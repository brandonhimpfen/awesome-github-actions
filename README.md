...
- [hybrid-rag-action](https://github.com/Cagrik34/hybrid-rag-action) – Automated repository issue and pull request triage using hybrid lexical and semantic search.
